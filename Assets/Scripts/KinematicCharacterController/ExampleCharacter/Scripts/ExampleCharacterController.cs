                    ...
                    // Air movement
                        ...
                        if (_moveInputVector.sqrMagnitude > 0f) {
                            ...
                            if (currentVelocityOnInputsPlane.magnitude < MaxAirMoveSpeed) {
                                ...
                                if (Vector3.Dot(currentVelocityOnInputsPlane, addedVelocity) > 0f) addedVelocity = Vector3.ProjectOnPlane(addedVelocity, currentVelocityOnInputsPlane.normalized);
                            }
